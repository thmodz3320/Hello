...
| $$ | $$ | $$      | $$ \____  $$ /$$  \ $$| $$  | $$| $$  \ $$
| $$ | $$ | $$      | $$ /$$$$$$$/|  $$$$$$/| $$$$$$$/|  $$$$$$/
|__/ |__/ |__/      |__/|_______/  \______/ |_______/  \______/ 
...
coded by m4s9b8
HTTP layer7 ddos tools
iranian hackers
Team channel : @Death_Squads
"""
...
def usage():
    ...
    print                              THEDON_BANNER
    print
    print  color.CYAN + ' Telegram : @m4s9b8 ' + color.END
    print
    ...
    print
    print
    print color.OKBLUE + ' iranian hackers  @m4s9b8 ' + color.END
    print
    print
    print color.NOTICE + '################################################################################' + color.END
    print
